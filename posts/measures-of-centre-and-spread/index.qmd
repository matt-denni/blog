...
3. If there is an even number of elements in the series, then there will be *two* numbers in the middle of the series, so it's necessary to find the *mean* of these two middle values to calculate the median.  Here's an example:
